...
pipeline {
    ...
    parameters {
        ...
        booleanParam(
            name: 'Build_Release', 
            defaultValue: false, 
            description: 'Builds the project and deploys it into nexus'
        )
        booleanParam(
            name: 'Snapshot', 
            defaultValue: true, 
        ...
        booleanParam(
            ...
            defaultValue: false, 
            description: 'Choose which database. and edit if needed'
        )
        booleanParam(
            name: 'TriggerPipeline', 
            defaultValue: false, 
            description: 'Starts the pipeline named testPipeline'
        )
